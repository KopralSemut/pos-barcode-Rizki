...
if (isset($_POST['btn_login'])) {
    ...
    if (is_array($row)) {
        ...
        echo $notif = "<div class=\"alert-success col-md-12\" style=\"max-width:24%;flex:unset\">Berhasil Login</div>";
    ...
    echo $notif ="<div class=\"alert-success col-md-12\" style=\"max-width:24%;flex:unset\">Username / Password Salah</div>";
}
}
?>
